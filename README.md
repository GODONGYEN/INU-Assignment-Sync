...
- 대상 LMS: [https://lms.inu.ac.kr](https://lms.inu.ac.kr)
...
- 수집 개월 범위를 확인합니다.
- 수강 강좌의 학습활동 모아보기에 과제가 있고 종료 일시가 지정되어 있는지 확인합니다.
...
## 신규 LMS 지원 (2026-09-21)

- `lms.inu.ac.kr`의 수강 강좌 메뉴와 강좌별 **학습활동 모아보기**에서 과제를 찾습니다. 홈의 이번 주 할 일만으로 수집하지 않습니다.
- 과제 상세의 **종료 일시**, 또는 **제출 기간**의 종료 시각을 사용합니다. 마감일이 없는 과제는 건너뛰며, 날짜 형식이나 강좌 로딩 오류가 있으면 부분 동기화를 중단합니다.
